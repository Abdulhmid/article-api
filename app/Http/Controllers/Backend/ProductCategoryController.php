...
class ProductCategoryController extends Controller
{
    ...
    protected $url = "product-category";
    protected $folder = "modules.product_category";
    protected $form;

    public function __construct(
        Md\Product_category $model
    )
    {
        $this->model    = $model;
        $this->form     = ProductCategoryForm::class;
     ...
     */
    public function index(ProductCategoryDataTables $dataTable)
    {
